...
useEffect(() => {
    fetch(`https://www.heal-zone.com/api/spas/${id}`, {
        credentials: "include",
    })
        .then((res) => res.json())
        .then((data) => {
...
if (loading)
    return <div className="details-loading">Loading Spa...</div>;

if (!spa)
    return <div className="details-loading">Spas not found.</div>;
    return (
                    ...
                    <section className="details-left">
                        ...
                        <div className="hero-gallery">
                            ...
                            <div className="hero-image-wrapper">
                                ...
                                <img
                                    ...
                                    src={
                                        spa.ImagesJson?.[selectedImage]?.url ||
                                ...
                                <div className="hero-overlay">
                                    ...
                                    <div>
                                        ...
                                        <div className="hero-rating">
                                            ...
                                            <span>⭐ {spa.Rating || "4.8"}</span>

                                            {/* <span>
                                                ({spa.ReviewsCount || 0} Reviews)
                                            </span> */}
                        ...
                        <div className="details-section">
                            ...
                            <p>
                                ...
                                {spa.SalonName} offers relaxing spa and wellness treatments with experienced therapists and premium products. Enjoy a calm environment designed to help you relax, rejuvenate, and refresh.
                        ...
                        <div className="details-section">
                            ...
                            <div className="section-header">
                                ...
                                <span>
                                    {spa.ServicesJson?.length || 0} Services
                                </span>
                ...
                <section className="details-bottom">
                    ...
                    <div className="details-section">
                        ...
                        <div className="gallery-grid">
                            ...
                            {spa.ImagesJson?.map((image, index) => (
                                ...
                                >
                                    ...
                                    <img
                                        src={image.url}
                                        alt={image.shortDescription || "spa"}
                                    />
                    ...
                    <div className="details-section">
                        ...
                        <div className="map-card">
                            ...
                            <iframe
                                title="spa Location"
                                src={`https://maps.google.com/maps?q=${spa.AddressJson.latitude},${spa.AddressJson.longitude}&z=15&output=embed`}
                                loading="lazy"
                            />
  ...
  onConfirm={async () => {
    ...
    try {
      ...
      const response = await fetch(
        "https://www.heal-zone.com/api/spa-bookings",
        {
          method: "POST",
