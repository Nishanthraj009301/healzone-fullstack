...
useEffect(() => {
    fetch(`https://www.heal-zone.com/api/salons/${id}`, {
        credentials: "include",
    })
        .then((res) => res.json())
        .then((data) => {
...
if (loading)
    return <div className="details-loading">Loading salon...</div>;

if (!salon)
    return <div className="details-loading">Salon not found.</div>;
    return (
                    ...
                    <section className="details-left">
                        ...
                        <div className="hero-gallery">
                            ...
                            <div className="hero-image-wrapper">
                                ...
                                <img
                                    ...
                                    src={
                                        salon.ImagesJson?.[selectedImage]?.url ||
                            ...
                            <div className="thumbnail-row">
                                ...
                                {salon.ImagesJson?.map((img, index) => (
                        ...
                        <div className="details-section">
                            ...
                            <p>
                                ...
                                {salon.SalonName} offers professional beauty and wellness
                                services with experienced stylists and premium products.
                                Relax in a modern environment while enjoying quality
                                treatments designed for your comfort.
                        ...
                        <div className="details-section">
                            ...
                            <div className="section-header">
                                ...
                                <span>
                                    {salon.ServicesJson?.length || 0} Services
                                </span>
  ...
  {salon.ServicesJson?.map((service) => (
                ...
                <section className="details-bottom">
                    ...
                    <div className="details-section">
                        ...
                        <div className="gallery-grid">
                            ...
                            {salon.ImagesJson?.map((image, index) => (
                                ...
                                >
                                    ...
                                    <img
                                        src={image.url}
                                        alt={image.shortDescription || "Salon"}
                                    />
                    ...
                    <div className="details-section">
                        ...
                        <div className="map-card">
                            ...
                            <iframe
                                ...
                                src={`https://maps.google.com/maps?q=${salon.AddressJson.latitude},${salon.AddressJson.longitude}&z=15&output=embed`}
                                loading="lazy"
                            />
